...
$qry="Select * from order_info where order_status='Delivered' order by order_date desc";
...
if(isset($_POST['search'])){
    ...
    $qry="Select * from order_info where order_status='Delivered' AND (order_id='$text' OR customer_id='$text' OR invoice_no='$text') order by order_date desc";
    $res=mysqli_query($con,$qry);
...
<head>
    ...
    <title>SHOPIFY | Admin - Delivered Orders</title>
