...
if(mysqli_num_rows($res)>0){
    ...
    while($val=mysqli_fetch_array($res)){
        ...
        $output.="
                        <tr>
                            ...
                            <td>$bname</td>
                            <td>
                                <a href='editcategory.php?category=$bid' id='edit'><i class='fa-solid fa-pen-to-square'></i></a> 
    ...
    $output.="
        <tr><td colspan='3'><h3 style='text-align:center;'>No Category Found</h3></td></tr>
    ";
}
...
<head>
    ...
    <title>SHOPIFY | Admin - View Category</title>
