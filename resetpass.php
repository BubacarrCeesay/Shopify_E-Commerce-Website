...
if(isset($_POST['reset'])){
    ...
    $cq="select * from customer where email='$email' and contact='$contact'";
    ...
    if(mysqli_num_rows($cr)<=0){
        ...
        if($pass != $cpass){
            ...
            $_SESSION['alert_info']="errorpass";
                ...
                $qry="Update customer set password='$pass'  where email='$email' and contact='$contact'";
...
<head>
    ...
    <title>SHOPIFY | User Reset Password </title>
  ...
  <script>
          ...
          function closeAlert() {
            ...
            if (isset($_SESSION['alert_info']) && $_SESSION['alert_info']=="success") {
                ...
                unset($_SESSION['alert_info']);
                echo "showAlert('⚠️ Invalid User Credentials');";
