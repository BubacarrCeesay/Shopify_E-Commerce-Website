        ...
        while($val=mysqli_fetch_array($rs)){
            ...
            $output.="
                            <tr>
                                ...
                                <td>$sz</td>
                                <td>$qnt</td>
                                <td><a href='rateprd.php?prd=$pid' id='ratebtn'><i class='fa-solid fa-star'></i> Rate Product </a></td>
                            </tr>
  ...
  <script>
          ...
          function closeAlert() {
            ...
            if (isset($_SESSION['alert_info']) && $_SESSION['alert_info']=="success") {
                ...
                echo "showAlert('✅ Thanks For Rating Our Product!');";
    
            }

            else if (isset($_SESSION['alert_info']) && $_SESSION['alert_info']=="not success") {
                unset($_SESSION['alert_info']);
                echo "showAlert('❌ Failed to Submit Rating. Try Again!'!');";
